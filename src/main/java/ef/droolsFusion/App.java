...
public class App 
{
    ...
    public void run () {
        ...
        WorkingMemoryEntryPoint entryPointSussex = ksession.getWorkingMemoryEntryPoint("Sussex");
        ...
        // workorders events in Sussex
        entryPointSussex.insert(new Workorder("ABC49", 40, 5, gang1));
        clock.advanceTime( 10, TimeUnit.SECONDS );
        entryPointSussex.insert(new Workorder("ABC76", 5, 10, gang1));
        clock.advanceTime( 10, TimeUnit.SECONDS );
        entryPointSussex.insert(new Workorder("ABC167", 5, 10, gang1));
        clock.advanceTime( 10, TimeUnit.SECONDS );
        entryPointSussex.insert(new Workorder("ABC236", 5, 50, gang1));
        clock.advanceTime( 10, TimeUnit.SECONDS );
